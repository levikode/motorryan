...
<p>invoice:{{ $dataTransaksi->invoice}}<br>Pembeli:{{ $dataTransaksi->pembeli->nama}}<br>Cashier:{{ Auth::user()->nama}}<br>Tanggal:{{$dataTransaksi->created_at->format('d M Y H:m')}}</p>
<table>
    <thead>
        <tr>
            <td>Produk</td>
